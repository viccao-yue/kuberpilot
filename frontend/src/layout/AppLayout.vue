  ...
  <div class="app-layout">
    <aside class="sidebar" :class="{ collapsed: appStore.sidebarCollapsed }">
      <div class="sidebar-logo">
        <div class="logo-icon">
          <img src="@/assets/brand-mark.svg" alt="KuberPilot" class="brand-mark" />
        </div>
        <div class="logo-copy">
          <span class="logo-text">KuberPilot</span>
...
const menuItems = [
  ...
  },
  {
    ...
    icon: 'DataLine',
    children: [
      { path: '/observability/boards', title: '仪表盘', icon: 'DataLine', anyPermissions: observabilityBoardPermissions },

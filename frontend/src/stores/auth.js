...
export const useAuthStore = defineStore('auth', () => {
  ...
  const previewMode = computed(() => isPreviewMode())

  const isAuthenticated = computed(() => previewMode.value || (!!token.value && !!currentUser.value))
  ...
  async function bootstrap() {
    ...
    if (previewMode.value) {
      persistToken(getPreviewToken())
      persistUser(getPreviewUser())

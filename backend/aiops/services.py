...
MCP_CLIENT_INFO = {'name': 'KuberPilot AIOps', 'version': '1.0.0'}
...
def build_platform_mcp_manifest(user=None):
    return {
        'name': 'sxdevops-aiops',
        'title': 'KuberPilot AIOps Platform MCP Server',
        'version': '2.1',
...
def list_model_provider_models(provider, probe=True, max_probe=8):
    ...
    headers = {
        ...
        'User-Agent': 'KuberPilot-AIOps/1.0',
    }
